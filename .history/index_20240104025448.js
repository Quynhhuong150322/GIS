...
//Kinh layer3
// import layer3DecorsFront from "./api/layer3/decors_Front/decors_Front.geojson" assert { type: "json" };
// import layer3DecorsFrontImport from "./api/layer3/decors_Front/decors_Front.geojson" assert { type: "json" };
...
require([
  ...
  // const layer3DecorsFront = new GeoJSONLayer({
  //   url: "./api/layer3/decors_Front/decors_Front.geojson",
  // });
  // layer3DecorsFront.renderer = {
  //   type: "simple",
  //   symbol: {
  //     type: "polygon-3d",
  //     symbolLayers: [
  //       {
  //         type: "fill",
  //         size: layer3DecorsFront.features[0].properties.height,
  //         material: {
  //           color: layer3DecorsFront.features[0].properties.color,
  //         },
  //         pattern: {
  //           type: "style",
  //           style: "cross",
